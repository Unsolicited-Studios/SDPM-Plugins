...
class IronBoots extends BurgerArmor
{
    /** @var float */
    ...
    {
        parent::__construct(new ItemIdentifier(ItemTypeIds::IRON_BOOTS), "Iron Boots", new ArmorTypeInfo(2, 196, ArmorInventory::SLOT_FEET));
    }

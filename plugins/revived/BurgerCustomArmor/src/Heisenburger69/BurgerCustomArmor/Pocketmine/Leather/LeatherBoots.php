...
class LeatherBoots extends BurgerArmor
{
    /** @var float */
    ...
    {
        parent::__construct(new ItemIdentifier(ItemTypeIds::LEATHER_BOOTS), "Leather Boots", new ArmorTypeInfo(1, 66, ArmorInventory::SLOT_FEET));
    }
